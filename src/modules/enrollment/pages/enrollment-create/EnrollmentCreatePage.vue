...
// EnrollmentCreatePage - Formulario de nueva matrícula
</script>
  ...
  <div class="min-h-screen bg-gray-50 pb-20">
    ...
    <header class="bg-[#B8D787] p-4 shadow-md">
      <div class="flex items-center">
        ...
        <div>
          <h1 class="text-xl font-bold text-white">Nueva Matrícula</h1>
          <p class="text-sm text-white/80">Registrar nuevo niño</p>
        </div>
      </div>
    </header>
    ...
    <main class="p-4">
      <form class="space-y-4">
        ...
        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700"> DNI del Niño </label>
          <input
            type="text"
            placeholder="Ingrese DNI del niño"
            class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:border-[#B8D787] focus:ring-2 focus:ring-[#B8D787] focus:outline-none"
          />
        </div>
        ...
        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700"> Turno </label>
          <select
